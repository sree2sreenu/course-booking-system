...
export class CoursesList implements OnInit {
  ...
  courses = [
    { id: 1, name: 'Angular Basics', description: 'Learn the fundamentals of Angular.', price: 50, date: "06/15/2025", soldOut: false, img:"angular-logo.png" },
    ...
    { id: 3, name: 'Angular and RxJS', description: 'Integrate RxJS with Angular applications.', price: 90, date: "06/15/2025", soldOut: true, img:"rxjs-logo.png" }
  ];
